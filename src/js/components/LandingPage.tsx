...
import './../../resources/scss/LandingPage.scss';


export default function LandingPage() {
  const logo = require('./../../resources/assets/img/rockstable-logo-white.png');
  const whitePaper = require('./../../resources/assets/2019_Whitepaper.pdf');
  return (<body>
      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse text-center" id="navbarSupportedContent">
          <ul className="navbar-nav ml-auto mt-2">
            ...
            <li className="nav-item">
              <a className="nav-link" href={whitePaper} >menu.white_paper</a>
            </li>
            <li className="nav-item">
